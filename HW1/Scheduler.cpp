...
bool comparePriority(const Instance& I1, const Instance& I2) {
    return I1.D < I2.D;
}

void Scheduler::clock_rma() {
        ...
        //Sort the deque
        sort(available_tasks.begin(), available_tasks.end(), comparePriority);
...
void Scheduler::process_rma(int max_clock) {
